    ...
    <div class="py-12">
        <div class="bg-white shadow-sm sm:rounded-lg p-6">
                        ...
                        <td class="border p-2">
                            @if ($field === 'date')
                                <input type="date"
                                    ...
                                    onchange="updateField({{ $reminder->id }}, '{{ $field }}', this.value)" />
            ...
            <a href="{{ route('reminders.index') }}" 
                class="inline-block bg-gray-600 text-white px-4 py-2 rounded">← Back</a>
        </div>
    </div>
    ...
    <script>
        ...
        function saveInlineEdit(inputElement, originalElement, id, field, oldValue) {
            ...
            if (newValue !== oldValue) {
                fetch(`/employee/reminders/${id}/inline-update`, {
                    method: 'POST',
                    headers: {
